<?php echo form_open('mhs_magang/add', array("class" => "form-horizontal")); ?>
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="surat_tugas" value="<?php echo $this->input->post('surat_tugas'); ?>" class="form-control" id="surat_tugas" />
