<?php echo form_open('kegiatan_magang/edit/' . $kegiatan_magang['id_kegiatan'], array("class" => "form-horizontal")); ?>
		...
		<div class="col-md-8">
			<select name="id_magang" class="form-control">
				...
				foreach ($all_tbl_magang as $magang) {
					$selected = ($magang['id_magang'] == $kegiatan_magang['id_magang']) ? ' selected="selected"' : "";
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="nama_kegiatan" value="<?php echo ($this->input->post('nama_kegiatan') ? $this->input->post('nama_kegiatan') : $kegiatan_magang['nama_kegiatan']); ?>" class="form-control" id="nama_kegiatan" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="deskripsi" value="<?php echo ($this->input->post('deskripsi') ? $this->input->post('deskripsi') : $kegiatan_magang['deskripsi']); ?>" class="form-control" id="deskripsi" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="tgl_kegiatan" value="<?php echo ($this->input->post('tgl_kegiatan') ? $this->input->post('tgl_kegiatan') : $kegiatan_magang['tgl_kegiatan']); ?>" class="form-control" id="tgl_kegiatan" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="alat" value="<?php echo ($this->input->post('alat') ? $this->input->post('alat') : $kegiatan_magang['alat']); ?>" class="form-control" id="alat" />
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="bahan" value="<?php echo ($this->input->post('bahan') ? $this->input->post('bahan') : $kegiatan_magang['bahan']); ?>" class="form-control" id="bahan" />
		...
		<div class="col-md-8">
			<select name="verif" class="form-control">
				...
				foreach ($verif_values as $value => $display_text) {
					$selected = ($value == $kegiatan_magang['verif']) ? ' selected="selected"' : "";
