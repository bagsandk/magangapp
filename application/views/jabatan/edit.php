<?php echo form_open('jabatan/edit/'.$jabatan['id_jabatan'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nama_jabatan" value="<?php echo ($this->input->post('nama_jabatan') ? $this->input->post('nama_jabatan') : $jabatan['nama_jabatan']); ?>" class="form-control" id="nama_jabatan" />
